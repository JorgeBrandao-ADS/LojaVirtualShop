...
function App() {
  ...
  const produtosFiltrados = ofertas
    ? [...produtos].sort((a, b) => b.rating.rate - a.rating.rate).slice(0, 6)
    : produtos.filter((produto) => {
        ...
        const correspondeCategoria =
          categoria === 'Todos' || produto.category === categoria;
  ...
  if (!token) {
    return <Login loginEnviado={fazerLogin} />;
  }
  ...
  return (
    <>
      <NavBar
        ...
        abrirCarrinho={() => setMostrarCarrinho(true)}
        logout={logout}
